...
## Project Structure
    ...
    ├── test_delivery_templ_41765  # Django project configurations
...
1. Clone this repo and `cd test_delivery_templ_41765`
...
2. Clone this repo and `cd test_delivery_templ_41765`
