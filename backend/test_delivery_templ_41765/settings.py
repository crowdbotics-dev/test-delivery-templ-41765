"""
Django settings for test_delivery_templ_41765 project.
...
ROOT_URLCONF = 'test_delivery_templ_41765.urls'
...
WSGI_APPLICATION = 'test_delivery_templ_41765.wsgi.application'
